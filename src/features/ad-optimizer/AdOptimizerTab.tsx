...
const ACTIVE_PROMPT = "Analyze the scene and apply the most logical creative variation for a Cabify advertisement, choosing ONE of the following transformations based on what makes sense for this specific image:- If the person is ALONE → add a second passenger beside them- If there are MULTIPLE people → remove one, keep the main subject only- If the scene is INSIDE the car → extend to show them arriving   at a Buenos Aires city street- If the scene is OUTSIDE the car → move them to the car interior,   looking relaxed- If the person is STATIC (looking at phone, sitting) → make them   active (waving, smiling at someone outside)- If the person is ACTIVE → make them calm and relaxed,   looking out the windowRules to always follow regardless of the transformation chosen:- Preserve the subject's face, skin tone, hair, and clothing exactly- Maintain natural daylight, shallow depth of field, candid photography style- Background must look like Buenos Aires or Córdoba urban environment- Do not add text, logos, or graphic overlays- The result must feel like a real Cabify campaign photo";
